...
import Strip from './app/screens/paymentscreen/Strip';
  ...
  return (
    <NavigationContainer
      ...
      <Stack.Navigator
        ...
        <Stack.Screen name="Payment" component={Strip} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
...
export default function () {
  return (
    <Provider store={store}>
      <StripeProvider
        publishableKey="pk_test_51Iy3T1Lfzpjj7PokLo8OXXpJthKnD8dSHf8HZql5AymvwUnZVDSGsbWQQiaCLSRmqKj08LnBl8c6vmMHHbzVynYK00z6bbrBzd"
        urlScheme="your-url-scheme" // required for 3D Secure and bank redirects
        merchantIdentifier="merchant.com.ClimateX" // required for Apple Pay
      >
